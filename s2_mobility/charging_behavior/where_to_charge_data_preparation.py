...
if __name__ == '__main__':
    ...
    print("Before extract info:", df_ce.shape, df_od.shape, df_ce['cs_name'].nunique())
    ...
    df_ce['seeking_duration'].to_csv('temp.csv')
    print("After extract info:", df_ce.shape)
    # Constraint 1: seeking_duration < 1 hour
    ...
    print("After constructing ground truth:", df_ce.shape)
    ...
    # gt = pd.merge(ce_feature['source_d_l'], d_hs_distribution, left_on='source_d_l', right_index=True)
    # gt = gt[df_cs['cs_name']]
