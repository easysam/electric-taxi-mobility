...
import numpy as np
from hotpots_discovery.hotpots_discovery_utils import plot_points, generate_cube_index, hotspots_discovery_meanshift, \
...
if __name__ == '__main__':
    ...
    # 读取transactions数据
    transactions = data_loader.load_od(scale='full', common=True)
    ...
    df_to_dump.to_csv(
        os.path.join(r'C:\Users\hkrep\PycharmProjects\ChargingEventsExtraction\data\od', 'full_od_with_hotpots_v4.csv'),
        index=False)
